...
export const TitanicNotationView: React.FC<TitanicNotationViewProps> = ({ 
  ...
  const song = PUBLISHED_SONG_NOTATIONS.find(s => s.slug === 'titanic-flute-notes') || PUBLISHED_SONG_NOTATIONS[2];
      ...
      <div className="max-w-6xl mx-auto px-1 sm:px-6 space-y-6 sm:space-y-10">
        ...
        <header className="bg-gradient-to-br from-amber-700 via-amber-800 to-bamboo-900 rounded-2xl sm:rounded-3xl p-4 sm:p-10 text-white shadow-xl relative overflow-hidden space-y-3 sm:space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-amber-500/30 backdrop-blur-md border border-amber-300/30 text-amber-200 text-[11px] sm:text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
              <Heart className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-rose-300" />
              Iconic Movie Theme
            </span>
        ...
        <section aria-label="Quick information" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-3 sm:space-y-4">
          ...
          <p className="text-[11px] sm:text-xs text-gray-500 italic pt-1">
            Note: Indian music uses movable Sa; you can play this arrangement on any flute scale you have.
          </p>
        </section>
        ...
        <section aria-label="Opening Instrumental Tune" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-4 sm:space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 border-b border-amber-100 pb-2.5 sm:pb-3">
            <h2 className="text-lg sm:text-2xl font-bold font-display text-bamboo-950 flex items-center gap-1.5 sm:gap-2">
              <Play className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 shrink-0" />
              <span>Opening Flute Tune (Instrumental Intro)</span>
            </h2>
          ...
          <div className="bg-amber-100/50 p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-amber-300/60 text-xs sm:text-sm text-amber-950 leading-relaxed font-sans space-y-1.5 sm:space-y-2">
            <p className="font-semibold text-amber-900 text-xs sm:text-sm">
              🎵 Quick Summary of Opening Tune:
            </p>
            <div className="font-mono font-black text-xs sm:text-base text-bamboo-950 space-y-1">
              ...
              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5 sm:gap-2.5">
                  {phrase.units.map((unit, uIdx) => (
                    <div 
                      key={uIdx} 
                      className="bg-white rounded-lg sm:rounded-xl p-2 sm:p-3.5 border border-amber-200/80 text-center space-y-1 sm:space-y-1.5 shadow-2xs hover:border-amber-400 transition flex flex-col justify-center min-h-[64px] sm:min-h-[76px]"
                    >
                      ...
                      <div className="font-mono text-[10px] sm:text-xs font-semibold text-slate-500">
                ...
                <div className="pt-1 flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-2 text-[11px] sm:text-xs text-gray-600 bg-white/70 p-2 sm:p-2.5 rounded-lg sm:rounded-xl border border-amber-200/60 font-mono">
                  <span className="text-gray-500 font-sans font-semibold shrink-0">Sargam line:</span>
        ...
        <section aria-label="Song Notation and Lyrics" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-4 sm:space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 border-b border-amber-100 pb-2.5 sm:pb-3">
            <h2 className="text-lg sm:text-2xl font-bold font-display text-bamboo-950 flex items-center gap-1.5 sm:gap-2">
              <Music className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 shrink-0" />
              <span>Song Notation (Sargam &amp; Lyrics)</span>
            </h2>
          ...
          <div className="space-y-3 sm:space-y-6">
            {versePhrases.map((phrase) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-1.5 sm:gap-2.5">
                  {phrase.units.map((unit, uIdx) => (
                    <div 
                      key={uIdx} 
        ...
        <section aria-label="Western Notes" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-4 sm:space-y-6">
          ...
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed font-sans">
            For Western concert flute, tin whistle, and keyboard learners playing with Sa mapped to C:
          </p>
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-1.5 sm:gap-2 border-b border-slate-200/80 pb-1.5 sm:pb-2.5">
                  <span className="text-[10px] sm:text-xs font-black uppercase tracking-wider text-slate-700 bg-slate-200 px-2 py-0.5 rounded-md">
                    {phrase.phraseNumber <= 2 ? 'Intro Line ' + phrase.phraseNumber : 'Verse Line ' + (phrase.phraseNumber - 2)}
                  </span>
        ...
        <section aria-label="Practice Routine" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-4 sm:space-y-6">
