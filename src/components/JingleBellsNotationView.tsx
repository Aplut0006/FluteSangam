...
export const JingleBellsNotationView: React.FC<JingleBellsNotationViewProps> = ({ 
  ...
  const song = PUBLISHED_SONG_NOTATIONS.find(s => s.slug === 'jingle-bells-flute-notes') || PUBLISHED_SONG_NOTATIONS[3];
      ...
      <div className="max-w-6xl mx-auto px-1 sm:px-6 space-y-6 sm:space-y-10">
        ...
        <section aria-label="Quick information" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-3 sm:space-y-4">
          ...
          <p className="text-[11px] sm:text-xs text-gray-500 italic pt-1">
            Note: Indian music uses movable Sa; this holiday melody can be played on any flute key you own.
          </p>
        </section>
        ...
        <section aria-label="Song notation" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-4 sm:space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-3 border-b border-amber-100 pb-2.5 sm:pb-3">
            <h2 className="text-lg sm:text-2xl font-bold font-display text-bamboo-950 flex items-center gap-1.5 sm:gap-2">
              ...
              <span>Song Notation (Chorus &amp; Verse)</span>
            </h2>
        ...
        <section aria-label="Phrase-by-phrase playing guidance" className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-amber-200 shadow-sm space-y-4 sm:space-y-6">
          <h2 className="text-lg sm:text-2xl font-bold font-display text-bamboo-950 flex items-center gap-2">
