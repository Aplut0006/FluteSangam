...
S`;
  ...
  return (
    ...
    >
      ...
      {/* Header Banner */}
      <section className="bg-gradient-to-br from-amber-100/90 via-orange-50 to-amber-50 text-bamboo-950 rounded-2xl sm:rounded-3xl p-4 sm:p-8 md:p-10 shadow-sm border border-amber-300/80 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-1 sm:gap-2 text-[11px] sm:text-xs text-amber-900 font-medium">
            <button 
              onClick={() => onViewChange?.('learn_dashboard')}
              className="hover:text-amber-700 transition cursor-pointer touch-manipulation"
            >
              Learn
            </button>
            <span>/</span>
            ...
            <span>/</span>
            <span className="text-bamboo-950 font-bold truncate max-w-[140px] sm:max-w-none">Raag Kafi</span>
          </div>

          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-amber-200/80 pb-5 sm:pb-6">
            <div>
              <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-amber-200/90 text-amber-950 px-2.5 sm:px-3 py-1 rounded-full text-[11px] sm:text-xs font-semibold mb-2 sm:mb-3 border border-amber-300 shadow-2xs">
                <Moon className="w-3.5 h-3.5 text-amber-700 shrink-0" />
                <span>2nd Quarter of Night (9 PM – 12 AM)</span>
              </div>
              <h1 className="text-2xl sm:text-4xl md:text-5xl font-black font-display tracking-tight text-bamboo-950 mb-2 sm:mb-3 leading-tight">
                Raag Kafi Guide
              </h1>
              <p className="text-xs sm:text-base text-stone-700 max-w-2xl leading-relaxed font-sans">
                Master Komal Ga (g) and Komal Ni (n), smooth meends, original Alankars, and the educational practice piece <span className="text-amber-900 font-semibold">"Komal Sur Lahari"</span> on Bansuri.
              </p>
            </div>
      ...
      <section className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-sm border border-bamboo-100 space-y-4 sm:space-y-6">
        ...
        <div className="bg-bamboo-50/80 border border-bamboo-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 space-y-3">
          ...
          <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-bamboo-200 space-y-1 font-mono text-sm sm:text-base font-bold text-bamboo-95 break-words0 break-words overflow-x-auto scrollbar-thin">
      ...
      <section className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-bamboo-100 space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-amber-50/50 border border-amber-200/80 rounded-2xl p-5 space-y-2">
            ...
            <p className="font-mono text-base sm:text-lg font-bold text-bamboo-95 break-words0 break-words tracking-widest">
              S &nbsp;&nbsp; R &nbsp;&nbsp; g &nbsp;&nbsp; M &nbsp;&nbsp; P &nbsp;&nbsp; D &nbsp;&nbsp; n &nbsp;&nbsp; S'
            </p>
          ...
          <div className="bg-emerald-50/50 border border-emerald-200/80 rounded-2xl p-5 space-y-2">
            ...
            <div className="font-mono text-base font-bold text-bamboo-95 break-words0 break-words space-y-1">
              <p>S R g M P D n S'</p>
              <p>S' n D P M g R S</p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-3xs space-y-2">
              ...
              <div className="font-mono text-xs sm:text-sm font-bold text-bamboo-95 break-words0 break-words space-y-1 bg-gray-50 p-3 rounded-xl">
