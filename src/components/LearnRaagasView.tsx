            ...
            <div className="grid gap-6 mt-8">
              ...
              {filter === 'Beginner' && (
                <div className="bg-gradient-to-br from-amber-500/10 via-amber-100/30 to-bamboo-500/10 border-2 border-amber-300 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      onClick={() => onViewChange?.('raga_brindavani_sarang')}
                      className="bg-teal-700 hover:bg-teal-800 text-white font-bold px-4 py-2.5 rounded-xl text-xs transition flex items-center gap-2 shadow-sm cursor-pointer"
                    >
                      <span>Raag Brindavani Sarang Guide ("Vrindavan Prabhat")</span>
                      <ArrowRight className="w-4 h-4" />
                    </button>
                  </div>
                </div>
              ...
              {filter === 'Intermediate' && (
                <div className="bg-gradient-to-br from-blue-500/10 via-indigo-100/30 to-bamboo-500/10 border-2 border-blue-300 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      onClick={() => onViewChange?.('raga_bhairav')}
                      className="bg-amber-900 hover:bg-amber-950 text-white font-bold px-4 py-2.5 rounded-xl text-xs transition flex items-center gap-2 shadow-sm cursor-pointer"
                    >
                      <span>Raag Bhairav Guide ("Pratah Dhyan")</span>
                      <ArrowRight className="w-4 h-4" />
                    </button>
                    <button
              ...
              {filteredRaagas.map((raaga, idx) => (
                <div key={idx} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-indigo-200 hover:shadow-md transition group">
                  ...
                  {(raaga.name.toLowerCase().includes('brindavani') || raaga.name.toLowerCase().includes('sarang')) && !raaga.name.toLowerCase().includes('shuddha') && (
                    <button
                      onClick={() => onViewChange?.('raga_brindavani_sarang')}
                      className="bg-teal-50 hover:bg-teal-100 text-teal-950 border border-teal-200 font-bold px-4 py-2 rounded-xl text-xs transition flex items-center gap-2 cursor-pointer mt-2"
                    >
                      <span>Read Full Raag Brindavani Sarang Guide &amp; Composition ("Vrindavan Prabhat")</span>
