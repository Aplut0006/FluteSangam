  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-bamboo-200/80 pb-5">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-bamboo-700 mb-1">
      ...
      <div className="bg-gradient-to-b from-white via-bamboo-50/30 to-amber-50/20 border border-bamboo-200/80 rounded-3xl p-6 sm:p-10 shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 mb-8 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-bamboo-100 shadow-3xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-bamboo-50 border border-bamboo-200 text-bamboo-900 text-xs font-bold rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-amber-500 cursor-pointer flex-1 md:flex-none"
            >
              {NOTE_NAMES.map(note => (
                <option key={note} value={note}>
                  Sa = {note} {note === 'A' ? '(440 Hz Standard)' : ''}
                </option>
              ))}
            </select>
          </div>
