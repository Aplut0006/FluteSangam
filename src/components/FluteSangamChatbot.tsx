      ...
      setMessages([
        {
          id: 'welcome-msg',
          sender: 'bot',
          text: 'Welcome to FluteSangam Assistant! Ask anything about learning the Indian Bansuri, flute selection, practice, techniques, raagas, or tap any category above to explore questions',
          timestamp: now
        }
      ]);
    }
