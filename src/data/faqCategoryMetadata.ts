...
export const FAQ_CATEGORY_METADATA: Record<string, FaqCategoryMeta> = {
  ...
  'flute-care-and-maintenance': {
    ...
    intro: 'A well-crafted bamboo bansuri is a living instrument that responds directly to changes in temperature, humidity, and moisture. Proper care ensures your flute retains its acoustic resonance, structural integrity, and tuning accuracy for decades. This section covers essential maintenance practices for bamboo flutes: understanding why and how to oil your bansuri using natural oils like mustard or walnut oil, preventing and repairing hairline cracks, maintaining protective thread bindings, and cleaning condensation from the bore. Follow these practical care guidelines to protect your bamboo flutes from seasonal weather fluctuations and keep them playing beautifully.',
