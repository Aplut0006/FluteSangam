...
export type AppView = 'community' | 'chats' | 'post-detail' | 'user-profile' | 'learn_intro' | 'learn_choose_flute' | 'learn_tuner' | 'learn_basics' | 'learn_fingering_chart' | 'learn_alankaras' | 'learn_raagas' | 'raga_bhoopali' | 'raga_durga' | 'raga_yaman' | 'raga_hamsadhwani' | 'alankar_generator' | 'community_members' | 'about_us' | 'founder' | 'contact_us' | 'learn_dashboard' | 'notation_requests' | 'privacy_policy' | 'terms_of_service' | 'not_found';
