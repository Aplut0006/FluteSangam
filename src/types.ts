...
export type AppView = 'community' | 'chats' | 'post-detail' | 'user-profile' | 'learn_intro' | 'learn_basics' | 'learn_choose_flute' | 'learn_alankaras' | 'learn_raagas' | 'community_members' | 'about_us' | 'contact_us' | 'learn_dashboard' | 'notation_requests' | 'privacy_policy' | 'terms_of_service';
