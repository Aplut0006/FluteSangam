...
export default function App() {
  ...
  useEffect(() => {
    ...
    switch (currentView) {
      ...
      case 'raga_pahadi':
        ...
        description = 'Learn Raag Pahadi with detailed notes, Aaroh, Avaroh, Pakad, characteristics, Aalap practice, flute tips, and an original FluteSangam learning piece.';
        break;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#fdfbf7] via-[#fff4e6] to-[#fdebd0] pb-24 md:pb-0" id="flutesangam-app-container">
      ...
      {/* Global Crawlable Footer */}
      <Footer onViewChange={handleViewChange} onSadhanaFeedClick={handleSadhanaFeedClick} />
